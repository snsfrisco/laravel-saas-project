        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body" style="display: block;">
                    ...
                    <form action="{{route('company_user.clients.update',$client->id)}}" method="post">
                        @method('put')
                        @csrf
                        @include('company_user.clients._form')
...
@endsection
@section('scripts')
@include('company_user.clients._client_form_common_js')
@endsection

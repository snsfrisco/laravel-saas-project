...
class ManagePortalRolesController extends PortalbaseController
{
    ...
    {
        if($request->ajax()){
            $roles = Role::whereNull('roleable_id')->whereNull('roleable_type')->whereNotIn('id', [1,2,3]);
    ...
    public function store(Request $request)
    {
        ...
        $role = Role::create(['name' => $request->name, 'guard_name' => $this->level_guard]);
